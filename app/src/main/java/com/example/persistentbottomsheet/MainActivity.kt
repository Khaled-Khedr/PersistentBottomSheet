...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bottomSheetBehavior = BottomSheetBehavior.from(view)//instance of the BottomSheetBehavior class and getting the behavior from view
        ...
        bottomSheetBehavior.addBottomSheetCallback(object:BottomSheetCallback(){  //implementing the interface
